...
const mainLogoImg = document.querySelector('.main-logo-img');//
...
const buttonBottom = document.querySelector('.button-bottom');
  ...
  */
  ...
  window.addEventListener('scroll', function() {
    ...
    if (isActive) {
      mainLogoImg.style.backgroundImage = "url('../image/logo-blue.svg')";
    } else {
      // 햄버거 메뉴를 닫았을 때 mainLogoImg의 배경색을 기본 로고로 변경합니다.
      mainLogoImg.style.backgroundImage = "url('../image/logo-w.svg')";
    }
  });
